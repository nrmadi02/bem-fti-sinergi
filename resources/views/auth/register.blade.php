    ...
    <div class="auth-inner my-2">
      ...
      <div class="card mb-0">
        <div class="card-body">
          ...
          <h4 class="card-title mb-1">Yuk gabung !! 🚀</h4>
          <p class="card-text mb-2">Daftar sanak-sanak BEM FTI, supaya kita bisa satu SINERGI.</p>
          ...
          <form class="auth-register-form mt-2" method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-1">
              ...
              <input type="text" class="form-control @error('name') is-invalid @enderror" id="register-username"
                name="name" placeholder="udin" aria-describedby="register-username" tabindex="1" autofocus
                value="{{ old('name') }}" />
              @error('name')
            ...
            <div class="mb-1">
              ...
              <input type="text" class="form-control @error('email') is-invalid @enderror" id="register-email"
                name="email" placeholder="udin@gmail.com" aria-describedby="register-email" tabindex="2"
                value="{{ old('email') }}" />
              @error('email')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
